(function () {
  ...
  function kt() {
    ...
    var r = Lt() - t;
    r > 24
      ? (isFinite(r) && (clearTimeout(js), (js = setTimeout(kt, r))), (Bs = 0))
      : ((Bs = 1), Fs(kt));
  }
  function Lt() {
    var e = null,
  ...
  function qt(e, t) {
    return d3.format(
      ",." +
        Math.max(0, -Math.floor(Math.log(Ft(e, t)[2]) / Math.LN10 + 0.01)) +
        "f"
    );
  }
  function Rt(e, t, n, r) {
  ...
  function zt(e, t) {
    ...
    return (
      ...
      (n.domain = function (i) {
        return arguments.length
          ? ((t = i[0] < 0 ? Xt : Wt), (r = t.pow), e.domain(i.map(t)), n)
          : e.domain().map(r);
      }),
      (n.nice = function () {
  ...
  function hn(e, t) {
    return e.length < 3
      ? un(e)
      : e[0] +
          dn((e.push(e[0]), e), vn([e[e.length - 2]].concat(e, [e[1]]), t));
  }
  function pn(e, t, n) {
        ...
        for (l = 3; l < p; l++) {
          ...
          if (d == 1)
            for (h = u._pack_prev; h !== c._pack_prev; h = h._pack_prev, m++)
              if (gr(h, f)) break;
          d
            ? (v < m || (v == m && a.r < u.r) ? mr(u, (a = c)) : mr((u = h), a),
              l--)
            : (vr(u, f), (a = f), t(f));
        }
      }
    ...
    function (e, t) {
      return (
        (typeof t == "string"
          ...
          : t instanceof U || t instanceof Q) && d3.interpolateRgb(e, t)
      );
    },
    function (e, t) {
    ...
    (Ss.transition = function () {
      ...
      for (var r = -1, i = this.length; ++r < i; ) {
        ...
        for (var s = this[r], o = -1, u = s.length; ++o < u; )
          t.push((n = s[o]) ? { node: n, delay: Ms, duration: _s } : null);
      }
      ...
      function e(s) {
        s.each(function () {
          ...
          s
            ...
            c.exit().remove(),
            o &&
              ((h = _t(o)), f.attr("x", h[0]).attr("width", h[1] - h[0]), n(s)),
            u &&
              ((h = _t(u)),
        ...
        (n.drag = function () {
          o ||
            (o = d3.behavior
              ...
              .on("drag", t)
              .on("dragend", Vn)),
            this.on("mouseover.force", $n).on("mouseout.force", Jn).call(o);
        }),
        d3.rebind(n, r, "on")
      );
    }),
          ...
          if (t) {
            ...
            while (((o = Ar(o)), (i = Lr(i)), o && i))
              (u = Lr(u)),
                ...
                h > 0 && (Br(jr(o, e, r), e, h), (a += h), (f += h)),
                (l += o._tree.mod),
                (a += i._tree.mod),
                (c += u._tree.mod),
                (f += s._tree.mod);
            o && !Ar(s) && ((s._tree.thread = o), (s._tree.mod += l - f)),
              i &&
                !Lr(u) &&
        ...
        (c = a.distance((f = e[t]))),
          c < u
            ...
            : ((o = f),
              !s &&
                i.length &&
                (i.push(ti(i[i.length - 1], o)((u - l) / (c - l))), (s = o))),
          (l = c);
      return (
        (s = e[0]),
        (o = i[0]),
        ...
        (e.clip = function (t) {
          ...
          while (++r < i) {
            ...
            while (++s < o)
              (l = n[s]),
                ii(l, u, a)
                  ? (ii(f, u, a) || t.push(si(f, l, u, a)), t.push(l))
  ...
  d3.time.format = function (e) {
    function t(t) {
      ...
      while (++i < n)
        e.charCodeAt(i) == 37 &&
          (r.push(e.substring(s, i), (u = Po[(o = e.charAt(++i))]) ? u(t) : o),
          (s = i + 1));
